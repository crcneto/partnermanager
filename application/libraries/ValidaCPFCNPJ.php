 ...
 * https://github.com/luizomf/valida-cpf-cnpj.git
 */
class ValidaCPFCNPJ {
	...
	protected function valida_cpf() {
            ...
            //verifica todos os números são iguais
            //alterado da fonte original
            $v = $this->valor;
	...
	protected function valida_cnpj () {
            ...
            //alterado da fonte original
            $v = $this->valor;
            if($v=='00000000000000' || $v=='11111111111111' || $v=='22222222222222' || $v=='33333333333333' || $v=='44444444444444' || $v=='55555555555555' || $v=='66666666666666' || $v=='77777777777777' || $v=='88888888888888' || $v=='99999999999999'){
                return false;
            }
